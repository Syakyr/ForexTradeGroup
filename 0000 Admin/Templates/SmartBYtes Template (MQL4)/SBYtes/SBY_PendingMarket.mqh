...
// This is the pending orders module for the SmartBYtes template. 
...
int OpenPositionPending(int TYPE, double OpenPrice, datetime expiration, double SL, double TP, 
                        int magicnumberoffset=0, double lotmultiple=1){
