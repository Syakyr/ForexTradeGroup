//+------------------------------------------------------------------+
//|                                               KeltnerChannel.mq4 |
//|                         Coded by Gilani, Adapted by SmartBYtesSG |
...
extern ENUM_MA_METHOD      MA_MODE     = MODE_SMA; //MA type
...
int start() {
   ...
   for(int x=0; x<limit; x++) {
      ...
      if (ATR_MODE)  avg  = iATR(NULL,0,ATR_PERIOD, x);
      else           avg  = findAvg(ATR_PERIOD, x);
